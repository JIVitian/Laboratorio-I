        ...
        <form name="oscimp_form" class="wah-main-admin-form clearfix" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
            ...
            <div class="wah_form_elements_wrapper">
                <div class="form_element_content">
                    ...
                    <div class="wahpro-placeholder">
                        <div class="pro-label">WAH PRO feture - Layout manager</div>
                        <img src="<?php echo plugin_dir_url( __FILE__ ); ?>img/layout_icons.png" alt="Layout manager">
                    </div>
            ...
            <div class="wah_form_elements_wrapper">
                <div class="form_element_content">
                    ...
                    <div class="wahpro-placeholder">
                        <div class="pro-label">WAH PRO feture - Sepia and Monochrome</div>
                        <img src="<?php echo plugin_dir_url( __FILE__ ); ?>img/sepia_monochrome.png" alt="Sepia & Monochrome">
                    </div>
            ...
            <div class="wah_form_elements_wrapper">
                <div class="form_element_content">
                    ...
                    <div class="wahpro-placeholder">
                        <div class="pro-label">WAH PRO feture - Large mouse cursor</div>
                        <img src="<?php echo plugin_dir_url( __FILE__ ); ?>img/cursor.png" alt="Large mouse cursor link">
                    </div>
                </div>
            </div>
            <hr />
            ...
            <div class="wahpro-placeholder">
                <div class="pro-label">WAH PRO feture - Custom link/button</div>
                <img src="<?php echo plugin_dir_url( __FILE__ ); ?>img/customlink.png" alt="Custom link">
            </div>

            <div class="wahpro-placeholder">
                <div class="pro-label">WAH PRO feture - Advanced settings</div>
                <img src="<?php echo plugin_dir_url( __FILE__ ); ?>img/advsettings.png" alt="Advanced settings">
            </div>
