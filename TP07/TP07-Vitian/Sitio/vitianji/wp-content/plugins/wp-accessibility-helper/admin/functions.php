...
<div class="wah-main-admin-sidebar">
                ...
                <div class="features-list">
                    ...
                    <ol>
                        ...
                        <li>
                            ...
                            <br><small><strong><?php _e('5 different layouts for your choice') ?></strong></small>
                        </li>
                        <li>
                        ...
                        <li><?php _e('Monochrome & Sepia modes','wp-accessibility-helper'); ?></li>
                        <li><?php _e('WPML Support','wp-accessibility-helper'); ?></li>
                        <li><?php _e('Polylang Support','wp-accessibility-helper'); ?></li>
                        <li><?php _e('Control cookies time', 'wp-accessibility-helper'); ?></li>
        ...
        <div class="for-chatter">

            <h3><?php _e("CHATTER PRO","wp-accessibility-helper"); ?></h3>

            <div class="wah-admin-sidebar-banner">
                <a href="https://accessibility-helper.co.il/chatter-pro/?from=wahfree" target="_blank" class="wahpro-banner-link">
                    <img src="https://accessibility-helper.co.il/wp-content/uploads/2020/04/chatter-box.png" alt="WAH PRO sidebar layouts manager">
                </a>
            </div>

            <div class="wah-admin-sidebar-inner">
                <div class="pro-button">
                    <a href="https://accessibility-helper.co.il/chatter-pro/?from=wahfree" target="_blank" class="button">
                        <?php _e('Get CHATTER PRO','wp-accessibility-helper'); ?>
                    </a>
                </div>

                <div class="features-list">
                    <h4><?php _e("CHATTER PRO features list:","wp-accessibility-helper"); ?></h4>
                    <ol>
                        <li>Accessibility ready chat system</li>
                        <li>Chat with subjects</li>
                        <li>Chat manager defined by admin</li>
                        <li>Export chat conversion to excel file</li>
                        <li>Email notifications</li>
                        <li>Manager tasks dashboard</li>
                    </ol>
